...
export default function ComandaDetalle({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-slate-900/50">
      <section className="h-full w-full max-w-2xl overflow-y-auto bg-white p-5">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-xl font-semibold text-slate-900">Comanda {comanda.codigo}</h2>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div>
            <h3 className="mb-2 text-sm font-semibold uppercase tracking-wide text-slate-500">Cliente</h3>
          ...
          <div>
            <h3 className="mb-2 text-sm font-semibold uppercase tracking-wide text-slate-500">Comanda</h3>
        ...
        <div className="mt-6">
          <h3 className="mb-2 text-sm font-semibold uppercase tracking-wide text-slate-500">Productos</h3>
        ...
        <div className="mt-6 space-y-4">
          <div>
            <h4 className="mb-2 text-sm font-semibold text-slate-700">Acciones de estado</h4>
            <div className="flex flex-wrap gap-2">
              ...
              <button
                ...
                className="rounded-md bg-red-600 px-3 py-2 text-sm font-medium text-white disabled:cursor-not-allowed disabled:bg-slate-300"
              >
                Cancelar comanda
              </button>
            </div>
          ...
          <div>
            <h4 className="mb-2 text-sm font-semibold text-slate-700">Gestión de pago</h4>
            <div className="flex flex-wrap gap-2">
              <button
                type="button"
          ...
          <div className="flex flex-wrap gap-2">
            <button type="button" onClick={() => onPrint(comanda)} className="rounded-md border border-slate-300 px-3 py-2 text-sm">
              Imprimir ticket
            </button>
            <button type="button" onClick={() => onSendWhatsApp(comanda)} className="rounded-md border border-slate-300 px-3 py-2 text-sm">
              Enviar WhatsApp
            </button>
            <button type="button" onClick={() => onCopySummary(comanda)} className="rounded-md border border-slate-300 px-3 py-2 text-sm">
              Copiar resumen
            </button>
          </div>
        </div>
